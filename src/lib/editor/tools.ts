...
import { BlockToolConstructorOptions, ToolConfig } from '@editorjs/editorjs'
...
class CustomSeparator extends Delimiter {
  ...
  static get toolbox() {
    return {
      icon: '<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M10 5V19" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
    }
  }
